                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                          <select class="form-select form-select-sm @error('txtgender') is-invalid @enderror" name="txtgender" id="txtgender">
                            ...
                            <option value="F" {{ (old('txtgender')=='M') ? 'selected' : '' }}>Female</option>
                          </select>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control @error('txtaddress') is-invalid @enderror" name="txtaddress" id="txtadddress" cols="30" rows="10"></textarea>
                          @error('txtaddress')
                            <div class="invalid-feedback">
                                {{ $message }}
                              </div>
