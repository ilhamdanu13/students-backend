        ...
        <div class="card-body">
            ...
            <form method="GET">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control form-control-sm" value="" placeholder="Please input key for search data..." name="search" autofocus value="{{ $search }}"/>
                    </div>
                </div>
            </form>
            <table class="table table-sm table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->phone }}</td>
                        <td>
                            <button type="button" onclick="window.location='{{ url('students/'.$row->idstudents) }}'" class="btn btn-sm btn-info" title="Edit Data">
